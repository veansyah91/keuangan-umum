...
export default function AddressSelectInput({
  data, selected, setSelected, query, setQuery, maxHeight = 'max-h-60', placeholder
}) 
  {
                    ...
                    {({ selected, active }) => (
                      <>
                        ...
                        >
                          ...
                          <div className='text-xs'>Kabupaten / Kota : {d.district.regency.name}</div>
                          <div className='text-xs'>Provinsi : {d.district.regency.province.name}</div>
