...
export default function GeneralMultipleSelectInput({
  data, 
  selected, 
  setSelected, 
  maxHeight = 'max-h-60', 
      ...
      <Listbox value={selected} onChange={setSelected} multiple>
        <div className="relative mt-1">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className={`absolute mt-1 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm ${maxHeight}`}>
              {data.map((d, index) => (
                <>
                <Listbox.Option
                  key={index}
