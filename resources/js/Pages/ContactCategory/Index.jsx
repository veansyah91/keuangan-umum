                ...
                <ContainerDesktop>
                    ...
                    <TitleDesktop>  
                        ...
                        <div className='w-3/12 border flex rounded-lg'>
                            ...
                            <input id='search-input' name='search-input' type="search" placeholder='Cari Kategori Kontak' className='w-full border-none focus:outline-none focus:ring-0' value={search || ''}
                            onChange={e => setSearch(e.target.value)}/>
                        </div>
