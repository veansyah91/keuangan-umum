        ...
        <div className='w-full sm:mt-2 sm:py-5'>
          <div className='sm:w-1/2 sm:mx-auto px-3 sm:px-0'>
            ...
            <div className='flex flex-col sm:flex-row justify-between gap-1 mt-5 sm:mt-2'>
              <div className='w-full sm:w-1/3 my-auto'>
                <InputLabel value={'No. Handphone (opsional)'} htmlFor='phone' className=' mx-auto my-auto'/>
              </div>
            ...
            <div className='flex flex-col sm:flex-row justify-between gap-1 mt-5 sm:mt-2'>
              <div className='w-full sm:w-1/3 my-auto'>
                <InputLabel value={'Alamat (opsional)'} htmlFor='address' className=' mx-auto my-auto'/>
              </div>
            ...
            <div className='flex flex-col sm:flex-row justify-between gap-1 mt-5 sm:mt-2'>
              <div className='w-full sm:w-1/3 my-auto'>
                <InputLabel value={'Informasi Tambahan (opsional)'} htmlFor='description' className=' mx-auto my-auto'/>
              </div>
            ...
            <div className='flex flex-col sm:flex-row justify-between gap-1 mt-5 sm:mt-2'>
              ...
              <div className='w-full sm:w-2/3'>
                <div className={`flex flex-wrap gap-3 ${errors?.category && 'border-red-500 border rounded-md'} `}>
                {
...
Create.layout = page => <AuthenticatedLayout
    ...
    backLink={<Link href={route('data-master.contact',page.props.organization.id)}><IoArrowBackOutline /></Link>}
