...
export default function Edit({
    ...
    const [selectedContact, setSelectedContact] = useState({
        id: cashIn.contact.id,
        name: cashIn.contact.name,
        phone: cashIn.contact.phone,
    });

    const [contactError, setContactError] = useState('');

    const [selectedCashAccount, setSelectedCashAccount] = useState(cashIn.cashAccount);
    ...
    const [selectedProject, setSelectedProject] = useState({
        id: cashIn.journal.project_id,
        name: cashIn.journal.project_id ? cashIn.journal.project.name : '',
        code: cashIn.journal.project_id ? cashIn.journal.project.codes : '',
    });

    const [projectError, setProjectedError] = useState('');

    const [selectedProgram, setSelectedProgram] = useState({
        id: cashIn.journal.program_id,
        name: cashIn.journal.program_id ? cashIn.journal.program.name : '',
        code: cashIn.journal.program_id ? cashIn.journal.program.codes : '',
    });
    const [programError, setProgramedError] = useState('');

    const [selectedDepartment, setSelectedDepartment] = useState({
        id: cashIn.journal.department_id,
        name: cashIn.journal.department_id ? cashIn.journal.department.name : '',
        code: cashIn.journal.department_id ? cashIn.journal.department.codes : '',
    });
