        ...
        <>
            ...
            <TitleMobile
                ...
                pageBefore={
                    logs.links[0].url ? (
                        <Link
                            href={`/logs/${organization.id}?page=${logs.current_page - 1}&search=${search}`}
                            preserveState
                            only={['logs']}>
                            <IoPlayBack />
                        </Link>
            ...
            <ContentMobile>
                {logs.data.map((log) => (
                    <LogMobile logItem={log} key={log.id} />
                ))}
            </ContentMobile>
            {/* Mobile */}
                ...
                <TitleDesktop>
                    ...
                    <div className='my-auto flex space-x-2 w-1/12'>
                        <div className='my-auto'>
                            {logs.links[0].url ? (
                                <Link
                                    href={`/logs/${organization.id}?page=${logs.current_page - 1}&search=${search}&start_date=${dateValue.startDate}&end_date=${dateValue.endDate}`}
                                    preserveState>
                                    <IoPlayBack />
                                </Link>
                            ) : (
