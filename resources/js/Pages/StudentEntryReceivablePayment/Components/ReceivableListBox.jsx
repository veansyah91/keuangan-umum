...
export default function ReceivableListBox({
    payments,
    selected,
    setSelected,
    maxHeight = 'max-h-60',
			...
			<div className='relative mt-1 w-full'>
				<div
					...
					<Combobox.Input
						...
						displayValue={(selected) => selected.noRef}
										...
										<>
											<div
												...
												<div className='text-xs flex'>
													Sisa: IDR. { formatNumber(d.receivable_value)}
												</div>
												<div className='text-xs flex'>
													Tahun Ajaran: {d.study_year}
												</div>
												<div className='text-base'>{d.no_ref.toUpperCase()}</div>
											</div>
											{selected ? (
												<div
