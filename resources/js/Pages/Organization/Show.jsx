        ...
        <>
            ...
            <div className='min-h-screen bg-gray-100'>
                <div className='max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white rounded-lg'>
                    <Header>
                        <div className='pt-4 text-center'>Detail Organisasi</div>
                    ...
                    <Container maxHeight='max-h-full'>
                        <div className=' px-8 sm:px-4'>Nama Organisasi:</div>
                        <div className='font-bold px-8 sm:px-4 mt-2'>{organization.name}</div>

                        <div className='mt-9 px-8 sm:px-4'>Alamat Organisasi:</div>
                        ...
                        <div className='mt-9 px-8 sm:px-4'>No Legalitas Organisasi:</div>
                        <div
                            className={`${organization.legality && 'font-bold'} px-8 sm:px-4 ${organization.legality ?? 'italic'}`}>
                            {organization.legality ?? 'Belum Ada Data'}
                        </div>

                        <div className='mt-9 px-8 sm:px-4'>Tanggal Pendaftaran:</div>
                        <div className='font-bold px-8 sm:px-4'>{organization.date}</div>

                        <div className='mt-9 px-8 sm:px-4'>Tanggal Kadaluarsa:</div>
                        <div className='font-bold px-8 sm:px-4'>
