            ...
            <Container>
                ...
                <div className='bg-white overflow-hidden shadow-sm sm:flex pb-4 px-2'>
                    <Card className={`mt-2 sm:mt-0 ${data.product == 'Bulanan' && 'border-[#57987f] border-2'}`}>
                        ...
                        <Card.CardContent>
                            {/* price */}
                            <div className='text-4xl'>Rp. 70.000</div>
                            <div className='italic text-sm'>Rp. 2.333 / hari</div>

                            {/* Description */}
                            <div className='mt-3 text-gray-500'>Berakhir Pada {organization.expiredAddAMonth}</div>
                        </Card.CardContent>
                        <div className='mt-5'>
                    ...
                    <Card className={`mt-2 sm:mt-0 ${data.product == 'Tahunan' && 'border-[#57987f] border-2'}`}>
                        ...
                        <Card.CardContent>
                            {/* price */}
                            <div className='text-4xl'>Rp. 600.000</div>
                            <div className='italic text-sm'>Rp. 1.643 / hari</div>
