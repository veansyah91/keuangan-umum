...
import { IoEllipsisVertical, IoAddOutline, IoChevronForward, IoCreateOutline, IoSearchOutline, IoAddCircleOutline, IoDocumentTextOutline, IoPersonAddOutline, IoTrashBinOutline, IoTrashOutline  } from "react-icons/io5";
                                                                ...
                                                                <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                                                                    {
                                                                        ...
                                                                        </li>
                                                                        {
                                                                            ...
                                                                            ? <>
                                                                                ...
                                                                                <li>
                                                                                    <Link href={`/organizations/${organization.id}/share-to-other`}>
                                                                                        <IoPersonAddOutline /> Tautkan Pengguna
                                                                                    </Link>
                                                                                </li>
                                                                            </>
                                                                            : <li>
                                                                                <button onClick={() => handleShowDelete(organization)}><IoTrashOutline />Hapus Tautan</button>
                                                                            </li>
                                                                        }      
                                                                        </>
                                                                    }
                                ...
                                organizations.map((organization, index) =>
                                    <div className='bg-white shadow-sm px-6 py-3 flex relative' key={index}>
                                        ...
                                        <div className='my-auto'>
                                            <div className="dropdown dropdown-left">
                                            <div tabIndex={0} role="button" className="bg-inherit border-none "><IoEllipsisVertical /></div>
                                                <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 bg-base-100 rounded-box w-52 border-1 border-gray-900 shadow">
                                                    {
                                                        organization.users[0].pivot.is_waiting ? 
                                                        <li className='flex justify-between flex-row'>
                                                            <div className='bg-green-600 hover:bg-green-400 text-white'>
                    ...
                    <form 
                        ...
                        <div className="mt-6 space-y-2">
                            <div className='text-center'>
                                Apakah Anda Yakin Menghapus Tautan Dengan <span className='font-bold'>{organizationDelete?.name?.toUpperCase()}</span> ?
                            </div>
