...
export default function Create({ organization, code }) {
    // state
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('data-master.project.post', organization.id), {
            onSuccess: ({ props }) => {
                ...
                <div className='w-full sm:mt-2 sm:py-5'>
                    <div className='sm:w-1/2 sm:mx-auto px-3 sm:px-0 space-y-5'>
                        ...
                        <div className='flex flex-col sm:flex-row justify-between gap-1'>
                            <div className='w-full sm:w-1/3 my-auto'>
                                <InputLabel
                                    value={'Estimasi Kebutuhan Biaya'}
                                    htmlFor='description'
                        ...
                        <div className='flex flex-col sm:flex-row justify-between gap-1'>
                            ...
                            <div className='w-full sm:w-2/3'>
                                ...
                                />
                                {errors?.start_date && (
                                    <span className='text-red-500 text-xs'>{errors.start_date}</span>
                                )}
                            </div>
                        </div>
...
Create.layout = (page) => (
    <AuthenticatedLayout
        header={<Header>Tambah Proyek</Header>}
        children={page}
        user={page.props.auth.user}
        organization={page.props.organization}
        title='Tambah Proyek'
        backLink={
            <Link href={route('data-master.project', page.props.organization.id)}>
                <IoArrowBackOutline />
            </Link>
        }
        breadcrumbs={
            <div className='text-sm breadcrumbs'>
                <ul>
                    ...
                    <li className='font-bold'>
                        <Link href={route('data-master.project', page.props.organization.id)}>Proyek</Link>
                    </li>
                    <li>Tambah Proyek</li>
                </ul>
            </div>
