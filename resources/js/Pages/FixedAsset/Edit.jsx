...
}) 
{
  ...
  const [selectedFixedAssetCategory, setSelectedFixedAssetCategory] = useState({
    id: fixedAssetCategory.id, name: fixedAssetCategory.name, lifetime: fixedAssetCategory.lifetime
  });

  const [selectedAccount, setSelectedAccount] = useState(
    {id: creditAccount.id, name: creditAccount.name, code: creditAccount.code, is_cash:creditAccount.is_cash},
  ); 
      ...
      <FormInput onSubmit={handleSubmit}>
        <div className='w-full sm:mt-2 sm:py-5'>
          <div className='sm:w-1/2 sm:mx-auto px-3 sm:px-0 space-y-3'>
            ...
            <div className='flex flex-col sm:flex-row justify-between gap-1'>
              <div className='w-full sm:w-1/3 my-auto'>
                <InputLabel value={'Kategori Harta Tetap'} htmlFor='category' className=' mx-auto my-auto'/>
              </div>
              ...
              <div className='w-full sm:w-2/3'>
                ...
                />
                {
                  errors?.fixed_asset_category && <span className='text-red-500 text-xs'>{errors.fixed_asset_category}</span>
                }
              </div>
            </div>
            <div className='flex flex-col sm:flex-row justify-between gap-1'>
              <div className='w-full sm:w-1/3 my-auto'>
                <InputLabel value={'Usia Pakai (Bulan)'} htmlFor='lifetime' className=' mx-auto my-auto'/>
              </div>
