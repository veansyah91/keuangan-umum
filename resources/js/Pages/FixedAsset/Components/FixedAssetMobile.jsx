        ...
        <div className=' text-gray-900 py-2 px-3 border flex gap-5 justify-between'>
            <div className='text-start my-auto w-6/12 space-y-2'>
                <div className='text-xs'>
                    <div>Nama: </div>
                    <div className='font-bold'>{fixedAsset.name.toUpperCase()}</div>
                </div>
                <div className='text-xs'>
                    <div>Kode: </div>
                    <div className='font-bold'>{fixedAsset.code.toUpperCase()}</div>
                </div>
                <div className='text-xs'>
                    <div>Tanggal Perolehan: </div>
                    <div className='font-bold'>{dayjs(fixedAsset.date).format('MMM DD, YYYY')}</div>
                </div>
            </div>
            <div className='text-start w-5/12 space-y-2'>
                <div className='text-sm'>
                    <div>Nilai Perolehan: </div>
                    <div className='font-bold'>IDR. {formatNumber(fixedAsset.value)}</div>
                </div>
            </div>
                    ...
                    {role !== 'viewer' && (
                        <div className='dropdown dropdown-left'>
                            ...
                            <ul
                                ...
                                <li>
                                    <Link
                                        href={route('data-master.fixed-asset.edit', {
                                ...
                                <li>
                                    <Link
                                        href={route('data-master.fixed-asset.show', {
                                            organization: fixedAsset.organization_id,
                                            fixedAsset: fixedAsset.id,
                                        })}>
