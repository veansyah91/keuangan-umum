...
export default function TrialBalance({
    ...
    return (
        <>
            <Head
                title={`Laporan Neraca Lajur : ${dayjs(startDate).format('MMMM DD, YYYY')} - ${dayjs(endDate).format('MMMM DD, YYYY')}`}
            />
            ...
            <div className='sm:pt-0 pb-16 pt-12'>
                <div className='bg-white py-2 sm:pt-0 px-5'>
                    ...
                    <div className='uppercase pt-9 pb-3 border-b hidden print:flex print:justify-between'>
                        <div className='w-1/2 text-2xl my-auto'>Laporan Neraca Lajur</div>
                            ...
                            <table className='table uppercase table-zebra table-xs'>
                                ...
                                <tbody>
                                    ...
                                    {dataBalances
                                        ...
                                        .map((balance, index) => (
                                            <TrialBalanceContent key={index} ledger={balance} />
                                        ))}

                                    {/* lost profit */}
                                    {dataLostProfits.map((lostProfit, index) => (
                                        <TrialBalanceContent key={index} ledger={lostProfit} />
                                    ))}
                                </tbody>
                                <tfoot>
                                    <TrialBalanceContent ledger={total} isTotal={true} />
                                </tfoot>
                            </table>
                        </div>
                    </div>
