...
export default function Ledger({ledgers, accounts, startedValue, organization, startDateFilter, endDateFilter, departments, projects, programs, department, project, program, account}) {
  // state
          ...
          <div className='flex sm:flex-row justify-between gap-2 print:hidden'>
            <div className='px-3 my-auto flex flex-col sm:flex-row gap-3 w-full sm:w-2/3'>
              ...
              <div className='my-auto hidden sm:block'>
                <PrimaryButton disabled={(!selectedAccount.id || !startDate || !endDate || startDate > endDate || isLoading)} onClick={handleReload}>Filter</PrimaryButton>
              </div>
            </div>
                ...
                <tbody>
                  <tr className='font-bold'>
                    ...
                    <td className='text-end'>
                      IDR. {formatNumber(total.startValue)}
                    </td>
                  </tr>
                {
                  ...
                  <tr className='font-bold'>
                    ...
                    <td className='text-end'>
                      IDR. {formatNumber(total.endValue)}
                    </td>
                    <td></td>
                  </tr>
                </tbody>
...
Ledger.layout = page => <AuthenticatedLayout
