...
export default function Cashflow({
    ...
    return (
        <>
            <Head
                title={`Laporan Arus Kas Periode : ${dayjs(startDate).format('MMMM DD, YYYY')} - ${dayjs(endDate).format('MMMM DD, YYYY')}`}
            />
            ...
            <div className='sm:pt-0 pb-16 pt-12'>
                <div className='bg-white py-2 sm:pt-0 px-5'>
                    ...
                    <div className='uppercase pt-9 pb-3 border-b hidden print:flex print:justify-between'>
                        <div className='w-1/2 text-2xl my-auto'>Laporan arus kas</div>
                            ...
                            {cashflows.length > 0 && (
                                <div className='mt-5'>
                                    <div className='flex w-full justify-between py-2 font-bold'>
                                        <div className='w-5/12 print:w-8/12 uppercase flex gap-2'>Kas Awal</div>
                                        <div className='w-2/12 print:w-4/12 text-center flex justify-end gap-3'>
                                            ...
                                            <div className='w-3/4 print:w-2/4 text-end'>
                                                {formatNumber(summaryCash.before)}
                                            </div>
                                        </div>
                                    </div>
                                    <div className='flex w-full justify-between py-2 font-bold'>
                                        ...
                                        <div className='w-2/12 print:w-4/12 text-center flex justify-end gap-3'>
                                            <div className='w-1/4 print:w-2/4 text-end'>Rp. </div>
                                            <div className='w-3/4 print:w-2/4 text-end'>
                                                {formatNumber(summaryCash.increase)}
                                            </div>
                                        </div>
                                    </div>
                                    <div className='flex w-full justify-between py-2 font-bold'>
                                        <div className='w-5/12 print:w-8/12 uppercase flex gap-2'>Kas Akhir</div>
                                        <div className='w-2/12 print:w-4/12 text-center flex justify-end gap-3'>
                                            <div className='w-1/4 print:w-2/4 text-end'>Rp. </div>
                                            <div className='w-3/4 print:w-2/4 text-end'>
                                                {formatNumber(summaryCash.after)}
                                            </div>
                                        </div>
                                    </div>
                                </div>
