...
export default function Edit({cashOut, organization, newRef, date, accounts, cashAccounts, projects, programs, departments, contacts}) {
  ...
  const [selectedContact, setSelectedContact] = useState(
    {id: cashOut.contact.id, name: cashOut.contact.name, phone:cashOut.contact.phone}
  ); 
  ...
  const [selectedProject, setSelectedProject] = useState({
    id: cashOut.journal.project_id, name: cashOut.journal.project_id ? cashOut.journal.project.name : '', code: cashOut.journal.project_id ? cashOut.journal.project.codes : ''
  });
  
  const [projectError, setProjectedError] = useState('');

  const [selectedProgram, setSelectedProgram] = useState({
    id: cashOut.journal.program_id, name: cashOut.journal.program_id ? cashOut.journal.program.name : '', code: cashOut.journal.program_id ? cashOut.journal.program.codes : ''
  });
  const [programError, setProgramedError] = useState('');

  const [selectedDepartment, setSelectedDepartment] = useState({
    id: cashOut.journal.department_id, name: cashOut.journal.department_id ? cashOut.journal.department.name : '', code: cashOut.journal.department_id ? cashOut.journal.department.codes : ''
  });
...
Edit.layout = page => <AuthenticatedLayout
  ...
  backLink={<Link href={route('cashflow.cash-out',page.props.organization.id)}><IoArrowBackOutline/></Link>}
  breadcrumbs={<div className="text-sm breadcrumbs">
    ...
    <li className='font-bold'><Link href={route('cashflow',page.props.organization.id)}>Arus Kas</Link></li> 
      <li className='font-bold'><Link href={route('cashflow.cash-out',page.props.organization.id)}>Kas Keluar</Link></li> 
