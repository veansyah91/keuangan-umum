...
export default function Index({ cashOuts, startDate, endDate, role, organization, searchFilter, isApproved, projects, programs, departments }) {
  ...
  return (
    <>
      ...
      {
      (role !== 'viewer') && <Link href={route('cashflow.cash-out.create', organization.id)}><AddButtonMobile label={"Tambah"}/></Link> 
      }
      <TitleMobile 
        zIndex={'z-50'}
        search={search}
        ...
        ? <Link href={`/cashflows/${organization.id}/cash-out?page=${cashOuts.current_page - 1}&search=${search}`} preserveState only={['cashOuts']}><IoPlayBack /></Link>
      ...
      <ContainerDesktop>
        <TitleDesktop>
          ...
          <div className='w-3/12 border flex rounded-lg'>					
            ...
            <input id='search-input' name='search-input' type="search" placeholder='Cari Kas Keluar' className='w-full border-none focus:outline-none focus:ring-0' value={search || ''}
          ...
          <div className='my-auto flex space-x-2 w-1/12'>
            ...
            <div className='my-auto'>{cashOuts.current_page}/{cashOuts.last_page}</div>
            <div className='my-auto'>
              {
                cashOuts.links[cashOuts.links.length-1].url 
                ? <Link 
        ...
        >
          ...
          <div className="mt-6 ">
            <div className='flex w-full gap-1'>
              <div className='w-1/4 my-auto font-bold'>
                Status
              </div>
