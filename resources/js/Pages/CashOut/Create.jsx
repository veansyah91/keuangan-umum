...
export default function Create({organization, newRef, date, accounts, cashAccounts, projects, programs, departments, contacts}) {
  ...
  const handleSubmit = (e) => {
    ...
    post(route('cashflow.cash-out.post', organization.id), {
      onSuccess: page => {
  ...
  const handleSelectedContact = (selected) => {
    ...
    temp = {
      ...
      'description': `Kas Keluar kepada ${selected.name.toUpperCase()}`
    }
    setData(temp);
  }
...
Create.layout = page => <AuthenticatedLayout
  header={<Header>Tambah Kas Keluar</Header>}
  children={page}
