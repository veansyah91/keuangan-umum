...
export default function Show({cashOut, organization, program, department, project, journal, ledgers, journalUser}) {
    const handlePrint = () => {
        window.print();
    }
    return (
        <>
            <Head title='Detail Kas Keluar Umum' />
            {/* Desktop */}
...
Show.layout = page => <AuthenticatedLayout
    header={<Header>Detail Kas Keluar</Header>}
    children={page}
