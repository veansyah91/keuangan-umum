                        ...
                        <div className='bg-white overflow-hidden shadow-sm sm:rounded-t-lg'>
                            <div className='sm:p-6 px-6 py-3 text-gray-800 flex-none sm:flex'>
                                <div className='sm:hidden text-gray-800 flex flex-col-reverse gap-5'>
                                    <div className='my-auto'>Afiliasi</div>
                                ...
                                <div className='sm:flex-1 my-auto sm:block hidden'>Afiliasi</div>
                            ...
                            {affiliationWithdraws.map((affiliationWithdraw) => (
                                <div className='flex gap-5 my-3' key={affiliationWithdraw.id}>
                                    ...
                                    <div className='w-3/12 text-end'>
                                        IDR. {formatNumber(affiliationWithdraw.value)}
                                    </div>
                                        ...
                                        <div className='dropdown dropdown-left my-auto'>
                                            ...
                                            <ul
                                                ...
                                                <li>
                                                    <Link
                                                        href={route(
                                                            'affiliationWithdraw.detail',
                                                            affiliationWithdraw.id
                                                        )}>
                    ...
                    <div className='p-5 space-y-5'>
                        ...
                        <div className='flex flex-col sm:flex-row justify-between gap-1'>
                            ...
                            <div className='w-full sm:w-2/3'>
                                ...
                                />
                                {errors?.bank_account && (
                                    <span className='text-red-500 text-xs'>{errors.bank_account}</span>
                                )}
                            </div>
                        </div>
                        <div className='flex flex-col sm:flex-row justify-between gap-1'>
                        ...
                        <div className='text-end space-x-2'>
                            <SecondaryButton type='button' onClick={() => setShowWithdrawModal(false)}>
                                Batal
                            </SecondaryButton>
                            <SuccessButton disabled={processing}>Ajukan</SuccessButton>
                        </div>
                    </div>
                </form>
            </Modal>
