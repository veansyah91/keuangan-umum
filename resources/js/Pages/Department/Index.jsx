...
export default function Index({ role, organization, departments, searchFilter, code }) {
    ...
    const handleSubmitInput = (e) => {
        ...
        isEdit
            ? patch(
                  route('data-master.department.update', {
    ...
    const handleSubmitDelete = (e) => {
        e.preventDefault();
        destroy(
            route('data-master.department.destroy', {
                organization: organization.id,
                department: selectedDepartment.id,
            }),
            {
    ...
    return (
        <>
                ...
                <TitleDesktop>
                    ...
                    <div className='w-3/12 border flex rounded-lg'>
                        ...
                        <input
                            ...
                            name='search-input'
                            type='search'
                            placeholder='Cari Departemen Kegiatan'
            ...
            <Modal show={showModalInput} onClose={handleCancelInput}>
                <form onSubmit={handleSubmitInput} className='p-6' id='Tambah' name='Tambah'>
                    <h2 className='text-lg font-medium text-gray-900'>{isEdit ? 'Edit' : 'Tambah'} Departemen</h2>
            ...
            <Modal show={showModalDetail} onClose={handleCloseDetailModal}>
                <div className='px-5 py-2'>
                    <div className='text-lg font-bold py-3 border-b'>Detail Departemen</div>
            ...
            <Modal show={showModalFilter} onClose={() => setShowModalFilter(false)}>
                <form onSubmit={handleFilter} className='p-6' id='filter' name='filter'>
                    <h2 className='text-lg font-medium text-gray-900'>Filter Departemen</h2>
