...
export default function Edit({
    ...
    // state
    const [selectedDebitAccount, setSelectedDebitAccount] = useState(cashMutation.accountDebit);

    const [selectedCreditAccount, setSelectedCreditAccount] = useState(cashMutation.accountCredit);

    const [selectedProject, setSelectedProject] = useState({
        id: cashMutation.journal.project_id,
        name: cashMutation.journal.project_id ? cashMutation.journal.project.name : '',
        code: cashMutation.journal.project_id ? cashMutation.journal.project.codes : '',
    });

    const [selectedProgram, setSelectedProgram] = useState({
        id: cashMutation.journal.program_id,
        name: cashMutation.journal.program_id ? cashMutation.journal.program.name : '',
        code: cashMutation.journal.program_id ? cashMutation.journal.program.codes : '',
    });

    const [selectedDepartment, setSelectedDepartment] = useState({
        id: cashMutation.journal.department_id,
        name: cashMutation.journal.department_id ? cashMutation.journal.department.name : '',
        code: cashMutation.journal.department_id ? cashMutation.journal.department.codes : '',
    });
    ...
    const handleSubmit = (e) => {
        ...
        patch(
            route('cashflow.cash-mutation.update', { organization: organization.id, cashMutation: cashMutation.id }),
            {
                onSuccess: (page) => {
