...
export default function Index({ cashMutations, startDate, endDate, role, organization, searchFilter, isApproved, projects, programs, departments }) {
  ...
  return (
    <>
      ...
      <TitleMobile 
        ...
        ? <Link href={`/cashflows/${organization.id}/cash-mutation?page=${cashMutations.current_page - 1}&search=${search}`} preserveState only={['cashMutations']}><IoPlayBack /></Link>
      ...
      <ContainerDesktop>
        <TitleDesktop>
          ...
          <div className='w-3/12 border flex rounded-lg'>					
            ...
            <input id='search-input' name='search-input' type="search" placeholder='Cari Mutasi Kas' className='w-full border-none focus:outline-none focus:ring-0' value={search || ''}
          ...
          <div className='my-auto flex space-x-2 w-1/12'>
            ...
            <div className='my-auto'>{cashMutations.current_page}/{cashMutations.last_page}</div>
            <div className='my-auto'>
              {
                cashMutations.links[cashMutations.links.length-1].url 
                ? <Link 
