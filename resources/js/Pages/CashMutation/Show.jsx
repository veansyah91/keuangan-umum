...
Show.layout = page => <AuthenticatedLayout
    header={<Header>Detail Mutasi Kas</Header>}
    children={page}
    ...
    breadcrumbs={<div className="text-sm breadcrumbs">
        <ul>
            ...
            <li className='font-bold'><Link href={route('cashflow.cash-out',page.props.organization.id)}>Mutasi Kas</Link></li> 
            <li>Detail Mutasi Kas</li>
        </ul>
    </div>}
