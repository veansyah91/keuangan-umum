...
export default function AccountMobile({account, handleEdit, handleDelete, role}) {
  return (
    <>
      <div className=' text-gray-900 py-2 px-3 border flex gap-5 justify-between'>
        <div className='text-start my-auto w-1/2'>
            <div className='text-xs'>{account.code.toUpperCase()}</div>
            <div>{account.name.toUpperCase()}</div>
        </div>
        <div className='text-center my-auto w-5/12'>
            {
