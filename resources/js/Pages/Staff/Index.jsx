...
export default function Index({ role, organization, contacts, searchFilter }) {
  // State
	...
	const createData = () => {
		reset();
		setIsUpdate(false);
		setModalInputLabel({title: 'Tambah Kontak Staf', submit: 'Tambah'});
		setError('name', '');
										...
										<ContentDesktop>
												<table className='table table-pin-rows table-pin-cols text-base'>
														<thead className='text-base text-gray-900'>
																<tr className=''>
																		<th className='bg-gray-200'>Nama Kontak Staf</th>
														...
														<tbody>
																{contacts.data.map((category, index) => (
								...
								<div className='mt-5 space-y-5'>
										<div className='flex flex-col sm:flex-row w-full gap-1'>
												<div className='w-full sm:w-1/3 my-auto'>
														<InputLabel htmlFor='name' value='Nama Kontak Staf' className='mx-auto my-auto' />
												</div>

												{/* <div className='sm:w-1/3 w-full my-auto'>Nama Kontak Staf Kontak</div> */}
