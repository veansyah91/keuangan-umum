...
export default function Index({organization, accountCategories, role, searchFilter}) {
  ...
  const handleSubmit = (e) => {
    ...
    isEdit 
    ? patch(route('data-ledger.account-category.patch', {organization: organization.id, accountCategory: id}), {
        onSuccess: () => {
        ...
        {/* Mobile */}
          ...
          <TitleMobile 
            ...
            pageBefore={
              ...
              ? <Link href={`/data-ledger/${organization.id}/account-categories?page=${accountCategories.current_page - 1}&search=${search}`} preserveState only={['accountCategories']}><IoPlayBack /></Link>
              : <div className='text-gray-300'><IoPlayBack /></div>
            }
            pageAfter={
                accountCategories.links[accountCategories.links.length-1].url 
                ? <Link href={`/data-ledger/${organization.id}/account-categories?page=${accountCategories.current_page + 1}&search=${search}`}
                    only={['accountCategories']} preserveState>
                    <IoPlayForward />
                </Link>
        ...
        <ContainerDesktop>
            ...
            <TitleDesktop>  
                ...
                <div className='w-3/12 border flex rounded-lg'>
                    ...
                    <input id='search-input' name='search-input' type="search" placeholder='Cari Kategori Akun' className='w-full border-none focus:outline-none focus:ring-0' value={search || ''}
                ...
                <div className='my-auto flex space-x-2 w-1/12'>
                    <div className='my-auto'>
                        {
                            ...
                            ? <Link 
                                    ...
                                    preserveState only={['accountCategories']}
                                >
                                    <IoPlayBack />
                                </Link>
                            : <div className='text-gray-300'><IoPlayBack /></div>
                    ...
                    <div className='my-auto'>{accountCategories.current_page}/{accountCategories.last_page}</div>
                    <div className='my-auto'>
                        {
                            accountCategories.links[accountCategories.links.length-1].url 
                            ? <Link 
