...
import StudentPaymentCategoryMobile from './Components/StudentPaymentCategoryMobile';
import StudentPaymentCategoryDesktop from './Components/StudentPaymentCategoryDesktop';
...
export default function Index({ role, organization, studentPaymentCategories, searchFilter }) {
    ...
    const handleDelete = (category) => {
        setTitleDeleteModal(`Hapus Rincian Biaya Bulanan ${category.name} ?`);
    ...
    const handleSubmit = (e) => {
        ...
        isUpdate
        ? patch(route('data-master.student-payment-category.update', {organization: organization.id, studentPaymentCategory: data.id}), {
            onSuccess: ({ props }) => {
                const { flash } = props;
        ...
        : post(route('data-master.student-payment-category.store', organization.id), {
            onSuccess: ({ props }) => {
                const { flash } = props;
    ...
    const handleSubmitDelete = (e) => {
        ...
        destroy(route('data-master.student-payment-category.destroy', { organization: organization.id, studentPaymentCategory: data.id }), {
            onSuccess: () => {
                setShowDeleteConfirmation(false);
                toast.success(`Rincian Biaya Bulanan Berhasil Dihapus`, {
                    position: toast.POSITION.TOP_CENTER,
                });
                reset();
            },
    ...
    return (
        <>
            {/* Mobile */}
            <Head title='Data Rincian Biaya Bulanan' />
            <ToastContainer />
            ...
            <TitleMobile
                ...
                pageBefore={
                    studentPaymentCategories.links[0].url ? (
                        <Link
                            href={`/data-master/${organization.id}/student-payment-category?page=${studentPaymentCategories.current_page - 1}&search=${search}`}
                            preserveState
                            only={['studentPaymentCategories']}>
                            <IoPlayBack />
                        </Link>
                ...
                <TitleDesktop>
                    ...
                    <div className='w-3/12 border flex rounded-lg'>
                        ...
                        <input
                            ...
                            name='search-input'
                            type='search'
                            placeholder='Cari Rincian Biaya Bulanan'
                    ...
                    <div className='my-auto flex space-x-2 w-1/12'>
                        <div className='my-auto'>
                            {studentPaymentCategories.links[0].url ? (
                                <Link
                                    href={`/admin/data-master/${organization.id}/student-payment-category?page=${studentPaymentCategories.current_page - 1}&search=${search}`}
                                    preserveState
                                    only={['studentPaymentCategories']}>
                                    <IoPlayBack />
                                </Link>
...
Index.layout = (page) => (
    <AuthenticatedLayout
        header={<Header>Data Rincian Biaya Bulanan</Header>}
        children={page}
        user={page.props.auth.user}
        organization={page.props.organization}
        title='Data Rincian Biaya Bulanan'
        backLink={
        ...
        breadcrumbs={
            <div className='text-sm breadcrumbs'>
                <ul>
                    ...
                    <li>Data Rincian Biaya Bulanan</li>
                </ul>
            </div>
        }
