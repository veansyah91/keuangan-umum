        ...
        <>
                ...
                <ContainerDesktop>
                    ...
                    <TitleDesktop>
                        ...
                        <div className='w-1/4 border flex rounded-lg'>
                            ...
                            <input id='search-input' name='search-input' type="search" placeholder='Cari Organisasi' className='w-full border-none focus:outline-none focus:ring-0' value={search || ''}
                            onChange={e => setSearch(e.target.value)}/>
                        </div>
                ...
                <form 
                    ...
                    <div className="mt-6 ">
                        <div className='flex w-full gap-1'>
                            ...
                            <div className='w-3/4'>
                                <select className="select select-bordered w-full max-w-xs" onChange={(e) => setDataFilter({status: e.target.value})} value={dataFilter.status}>
            ...
            <Modal show={showModalUpdate} onClose={() => setShowModalUpdate(false)}>
                <form 
                    ...
                    className="p-6">
                    <h2 className="text-lg font-medium text-gray-900">
                        Ubah Status {organizationEdit.name}
                    </h2>
                    ...
                    <div className="mt-6 ">
                        ...
                        <div className='space-y-2'>
                            <div className='space-x-2'>
                                ...
                                />
                                <label htmlFor="trial" className='my-auto'>Masa Uji Coba</label>
                            </div>
                            <div className='space-x-2'>
                                <input type="radio" name="radio-1" id='active' className="radio my-auto focus:text-gray-900" defaultChecked={organizationEdit.status == 'active'} onChange={() => setData({status:'active'})}/>
                                <label htmlFor="active" className='my-auto'>Aktif</label>
                            </div>
                            <div className='space-x-2'>
                                <input type="radio" name="radio-1" id='deactive' className="radio my-auto focus:text-gray-900" defaultChecked={organizationEdit.status == 'deactive'} onChange={() => setData({status:'deactive'})}/>
                                <label htmlFor="deactive" className='my-auto'>Tidak Aktif</label>
                            </div>
                        </div>
