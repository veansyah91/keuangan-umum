        ...
        <>
            ...
            <TitleMobile
                ...
                pageBefore={
                    regencies.links[0].url ? (
                        <Link
                            href={`/admin/data-master/regencies?page=${regencies.current_page - 1}&search=${search}`}
                            preserveState>
                            <IoPlayBack />
                        </Link>
                    ) : (
            ...
            <ContentMobile>
                {regencies.data.map((regency) => (
                    <RegencyMobile regency={regency} key={regency.id} />
                ))}
            </ContentMobile>
            {/* Mobile */}
                ...
                <TitleDesktop>
                    ...
                    <div className='my-auto flex space-x-2 w-1/12'>
                        <div className='my-auto'>
                            {regencies.links[0].url ? (
                                <Link
                                    href={`/admin/data-master/regencies?page=${regencies.current_page - 1}&search=${search}${selectedProvince && `&province=${selectedProvince.id}`}`}
                                    preserveState>
                                    <IoPlayBack />
                                </Link>
                            ) : (
            ...
            <Modal show={showModalImport} onClose={() => setShowModalImport(false)}>
                <form onSubmit={handleSubmitImport} className='p-6'>
                    <h2 className='text-lg font-medium text-gray-900'>Import Kabupaten / Kota</h2>
            ...
            <Modal show={showModalFilter} onClose={() => setShowModalFilter(false)}>
                <form onSubmit={handleFilter} className='p-6'>
                    <h2 className='text-lg font-medium text-gray-900'>Filter Kabupaten / Kota</h2>
