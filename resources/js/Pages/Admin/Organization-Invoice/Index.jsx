            ...
            <TitleMobile
                ...
                pageBefore={
                    organizationInvoices.links[0].url ? (
                        <Link
                            href={`/admin/data-master/organizationInvoices?page=${organizationInvoices.current_page - 1}&search=${search}`}
                            preserveState>
                            <IoPlayBack />
                        </Link>
                    ) : (
                ...
                <TitleDesktop>
                    ...
                    <div className='w-1/4 border flex rounded-lg'>
                        ...
                        <input
                            ...
                            name='search-input'
                            type='search'
                            placeholder='Cari Invoice Organisasi'
                    ...
                    <div className='my-auto flex space-x-2 w-1/12'>
                        <div className='my-auto'>
                            {organizationInvoices.links[0].url ? (
                                <Link
                                    href={`/admin/organizations?page=${organizationInvoices.current_page - 1}&search=${search}&start_date=${dateValue.startDate}&end_date=${dateValue.endDate}&status=${dataFilter.status}&product=${dataFilter.product}&organization_id=${selectedOrganization.id}`}
                                    preserveState>
                                    <IoPlayBack />
                                </Link>
                            ) : (
                        ...
                        <div className='flex w-full gap-1'>
                            ...
                            <div className='w-1/12 my-auto'>
                                {selectedOrganization && (
                                    <button className='p-2' onClick={handleDeleteOrganizationFilter}>
                                        <IoTrash />
                                    </button>
                                )}
                            </div>
