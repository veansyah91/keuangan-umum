        ...
        <div className='border-2' {...props}>
            <div className=' text-gray-900 py-2 border flex justify-between px-2'>
                <div className='w-1/2'>
                    ...
                    <div className='text-sm'>{organizationInvoice.organization.name}</div>
                    ...
                    <div className='w-1/8'>
                        <div className='dropdown dropdown-left'>
                            <div
                                ...
                                role='button'
                                className={`btn bg-white border-none hover:bg-gray-100 -z-50 ${organizationInvoice.status !== 'pending' && 'text-gray-300'}`}>
                                <IoEllipsisVertical />
                            </div>
                            <ul
                                tabIndex={0}
