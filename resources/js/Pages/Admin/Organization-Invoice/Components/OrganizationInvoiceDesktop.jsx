    ...
    return (
        <tr className={className} {...props}>
            ...
            <td>    
                ...
                {
                    organizationInvoice.status == 'pending' && <div className='italic text-yellow-600 my-auto'>Menunggu</div>
                }
                {
            ...
            <td>
                <div className="dropdown dropdown-left">
                    <div tabIndex={organizationInvoice.status !== 'pending' ? '' : 0} role="button" className={`bg-inherit border-none -z-50 ${organizationInvoice.status !== 'pending' && 'text-gray-300'}`}><IoEllipsisVertical /></div>
                    <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-60">
                        <li>                                
                            <button onClick={handleEdit}><IoCreateOutline />Konfirmasi Pembayaran</button>
                        </li>
                    </ul>
                </div>
            </td>
