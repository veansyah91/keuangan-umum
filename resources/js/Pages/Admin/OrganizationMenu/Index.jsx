            ...
            <ContainerDesktop>
                <div className='flex justify-center pt-5 pb-10 gap-2'>
                    <Link href={route('admin.organization.index')}>
                        <CardMenu bgColor={'bg-orange-500'} icon={<IoReaderOutline />} title={'Daftar Organisasi'} />
                    </Link>
                    <Link href={route('admin.organization.invoice.index')}>
                        <CardMenu bgColor={'bg-cyan-500'} icon={<LiaFileInvoiceSolid />} title={'Invoice Organisasi'} />
                    </Link>
                </div>
            </ContainerDesktop>
