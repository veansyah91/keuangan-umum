        ...
        <>
            ...
            <TitleMobile
                ...
                pageBefore={
                    districts.links[0].url ? (
                        <Link
                            href={`/admin/data-master/districts?page=${districts.current_page - 1}&search=${search}`}
                            preserveState>
                            <IoPlayBack />
                        </Link>
                    ) : (
            ...
            <ContentMobile>
                {districts.data.map((district) => (
                    <DistrictMobile district={district} key={district.id} />
                ))}
            </ContentMobile>
            {/* Mobile */}
            ...
            <Modal show={showModalImport} onClose={() => setShowModalImport(false)}>
                <form onSubmit={handleSubmitImport} className='p-6'>
                    <h2 className='text-lg font-medium text-gray-900'>Import Kecamatan</h2>
            ...
            <Modal show={showModalFilter} onClose={() => setShowModalFilter(false)}>
                <form onSubmit={handleFilter} className='p-6'>
                    <h2 className='text-lg font-medium text-gray-900'>Filter Kecamatan</h2>
