    ...
    return (
        <>
            ...
            <TitleMobile
                ...
                pageBefore={
                    users.links[0].url ? (
                        <Link href={`/admin/users?page=${users.current_page - 1}&search=${search}`} preserveState>
                            <IoPlayBack />
                        </Link>
                    ) : (
                ...
                pageAfter={
                    users.links[users.links.length - 1].url ? (
                        <Link
                            href={`/admin/users?page=${users.current_page + 1}&search=${search}`}
                            only={['users']}
                            preserveState>
                            <IoPlayForward />
                        </Link>
                ...
                {userCollections.map((user) => (
                    <div key={user.id} className=' text-gray-900 py-2 px-1 border flex justify-between'>
                        <div className=''>
                            ...
                            <div className='text-sm'>Dibuat Tanggal: {user.date}</div>
            ...
            <ContainerDesktop>
                ...
                <TitleDesktop>
                    ...
                    <div className='italic text-xs my-auto w-1/12 text-center'>
                        {formatNumber(users.current_page * users.per_page - (users.per_page - 1))}-
                        {formatNumber(users.to)} dari {formatNumber(users.total)}
                    </div>
                        ...
                        <tbody className=''>
                            {userCollections.map((user, index) => (
                                <tr className={`${index % 2 == 0 && 'bg-gray-100'}`} key={index}>
                                    ...
                                    <td className=''>{user.affiliation}</td>
                                        ...
                                        {!user.affiliation && (
                                            <div className='dropdown dropdown-left'>
                                                ...
                                                <ul
                                                    ...
                                                    <li>
                                                        <button onClick={() => handleSetAffiliation(user)}>
                                                            <GiTakeMyMoney />
                                                            Afiliasi
                                                        </button>
                                                    </li>
            ...
            <Modal show={showAffilateModal} onClose={() => setShowAffiliateModal(false)}>
                <form onSubmit={handleSubmitAffiliation}>
                    <div className='p-5'>
                        <h2 className='text-lg font-medium text-gray-900'>Buat Affiliasi</h2>
                        <section className='mt-5 space-y-2'>
                            ...
                            <div className='flex flex-col sm:flex-row justify-between gap-1'>
                                ...
                                <div className='w-full sm:w-2/3'>
                                    ...
                                    />
                                    {errors?.insentive && (
                                        <span className='text-red-500 text-xs'>{errors.insentive}</span>
                                    )}
                                </div>
                            </div>
                        </section>
