...
export default function Index({ role, organization, programs, searchFilter, code }) {
    ...
    const handleSubmitInput = (e) => {
        ...
        isEdit
            ? patch(
                  route('data-master.program.update', { organization: organization.id, program: selectedProgram.id }),
                  {
                      onSuccess: () => {
        ...
        <>
            ...
            <Modal show={showModalInput} onClose={handleCancelInput}>
                <form onSubmit={handleSubmitInput} className='p-6' id='Tambah' name='Tambah'>
                    <h2 className='text-lg font-medium text-gray-900'>{isEdit ? 'Edit' : 'Tambah'} Program Kegiatan</h2>
            ...
            <Modal show={showModalDetail} onClose={handleCloseDetailModal}>
                <div className='px-5 py-2'>
                    <div className='text-lg font-bold py-3 border-b'>Detail Program Kegiatan</div>
