...
export default function ProgramDesktop({program, className, handleDelete, handleEdit, handleShow, role}) {
  return (
    <>
      <tr className={className}>
          ...
          <td className='text-center'>
            {program.is_active ? <BadgeSuccess>Aktif</BadgeSuccess> : <BadgeDanger>Tidak Aktif</BadgeDanger>}            
          </td>
